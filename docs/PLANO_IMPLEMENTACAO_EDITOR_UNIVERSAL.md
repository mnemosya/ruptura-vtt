...
### Etapa 10 (drone/robô/trama)
- Confirmado pela auditoria: automação real hoje é parcial ou inexistente para quase todos esses efeitos. Esta etapa deve ser tratada como "engine + editor" combinada, não só editor — o aditivo já reconhece isso (§10.16/§Etapa 10: "nenhuma automação é anunciada como completa sem executor").
