/**
 * Conjunto mínimo de ícones de traço (24×24, `currentColor`) usado pela
 * tela de autenticação e pela área autenticada global.
 *
 * O protótipo do Figma Make importava `lucide-react`. Aqui os mesmos
 * desenhos vivem como SVG inline: o repositório não ganha dependência
 * nova por causa de ~25 ícones, e o conjunto fica explícito (nada de
 * árvore de ícones inteira no bundle). Todos são decorativos por padrão
 * (`aria-hidden`) — quem precisar de rótulo põe no elemento que os
 * contém.
 */
...
function Svg({ size = 16, strokeWidth = 2, children, ...rest }: IconProps & { children: React.ReactNode }) {
  return (
    <svg
