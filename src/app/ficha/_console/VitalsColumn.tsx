 ...
 * cobalto), atributos e os blocos de vitais — Integridade e Sobrecarga
 * como faixas de um painel contínuo, Deslocamento/PA/Reações cada um
 * no seu card.
 *
 * Simplificado para seguir o wireframe literalmente: caixas com borda
 * simples, sem ícone por atributo, sem gradiente, sem canto cortado
 * fora do hexágono do retrato/atributos que o próprio desenho já tem.
 *
  ...
  return (
    <div className="rc-col">
      ...
      <div className="rc-stack">
        ...
        <div>
          <div className="rc-block-head">
            <span className="rc-block-label rc-block-label--danger">Sobrecarga</span>
            <span className="rc-block-value">
